...
void callBack(const sensor_msgs::PointCloud2ConstPtr& input)
{
    ...
    pcl::PointCloud<pcl::PointXYZ>::Ptr cloud_filtered(new pcl::PointCloud<pcl::PointXYZ>), cloud(new pcl::PointCloud<pcl::PointXYZ>), plane_out(new pcl::PointCloud<pcl::PointXYZ>), plane_please_work(new pcl::PointCloud<pcl::PointXYZ>);
    ...
    plane_out = scanAxis(cloud_filtered);
    plane_please_work = smooth(cloud_filtered);

    pcl::visualization::PCLVisualizer::Ptr viewer;
viewer = simpleVis(plane_please_work);
